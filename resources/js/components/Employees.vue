<template>
    <div>
                    ...
                    <div class="d-flex align-items-center flex-wrap mr-1">
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center font-weight-bold my-2">
                                ...
                                <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Track and
                                    Trace Employee</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <span class="float-right">
                                        ...
                                        <a href="#" @click="showFilterEmployees('1')" class="text-default"><i
                                                class="fas fa-id-badge text-success" title="Registered"
                                                style="cursor:pointer;"></i> {{ totalRegistered.length }} |</a>
                                        <a href="#" @click="showFilterEmployees('0')" class="text-default"><i
                                                class="fas fa-id-badge text-danger icon-md" title="Not Registered"
                                                style="cursor:pointer;"></i> {{ totalNotRegistered.length }} | </a>
                            ...
                            <div class="float-left mt-5 mr-2">
                                <div class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" v-model="show_favorites"
                                        @change="saveSessionShowFavorites" />
                                        ...
                                        <tr v-for="(employee, i) in filteredEmployeeQueues" :key="i">
                                            ...
                                            <td style="vertical-align: middle;">
                                                ...
                                                <span style="font-size:11px"> {{ employee.position }} |
                                                    ...
                                                    |
                                                    {{ employee.companies.length > 0 ? employee.companies[0].name : "" }}
                                                    |
                            ...
                            <div class="row" v-if="filteredEmployeeQueues.length">
                                <div class="col-md-12">
                                    <span class="float-right">
                                        <button :disabled="!showPreviousLinkEmployee()"
        ...
        <div class="modal fade" id="apply-filter-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" v-model="filter.department" id="department">
                                        ...
                                        <option v-for="(department, v) in departments" v-bind:key="v"
...
export default {
    ...
    computed: {
        filteredEmployees() {
            let v = this;
            if (v.employees) {
                return Object.values(v.employees);
            } else {
                return [];
            }
