<template>
    <div>
                ...
                <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                    <div class="d-flex align-items-center flex-wrap mr-1">
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center font-weight-bold my-2">
                                <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Employee Tracker
                                    Per Locations</a>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        <a href="#" @click="refresh"
                            class="btn btn-transparent-white font-weight-bold py-3 px-6 mr-2">Refresh
                            {{ timer ? "(" + timer + ")" : "" }}</a>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card card-custom gutter-b wave wave-animate-slow wave-success">
                                <div class="card-body">
                                    <div class="text-enter">
                                        <center>
                                            <vue-ellipse-progress :progress="progressBgc" :legendValue="actualInBGC.length"
                                                color="#00713A">
                                                <span slot="legend-value"> / {{ totalInBGC.length }}</span>
                                                <p slot="legend-caption" @click="viewSelectedEmployees(actualInBGC, 'BGC')"
                                                    style="cursor:pointer;"><strong>BGC</strong></p>
                        ...
                        <div class="col-xl-4">
                            <div class="card card-custom gutter-b wave wave-animate-slow wave-primary">
                                <div class="card-body">
                                    <div class="text-enter">
                                        <center>
                                            <vue-ellipse-progress :progress="progressManila"
                                                :legendValue="actualInManila.length" color="#003494">
                                                <span slot="legend-value"> / {{ totalInManila.length }}</span>
                                                <p slot="legend-caption"
                                                    @click="viewSelectedEmployees(actualInManila, 'MANILA')"
                                                    style="cursor:pointer;"><strong>MANILA</strong></p>
                                            </vue-ellipse-progress>
                                        </center>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card card-custom gutter-b wave wave-animate-slow wave-warning">
                                <div class="card-body">
                                    <div class="text-enter">
                                        <center>
                                            <vue-ellipse-progress :progress="progressIloilo"
                                                :legendValue="actualInIloilo.length" color="#FFD840">
                                                <span slot="legend-value"> / {{ totalInIloilo.length }}</span>
                                                <p slot="legend-caption"
                                                    @click="viewSelectedEmployees(actualInIloilo, 'ILOILO')"
                                                    style="cursor:pointer;"><strong>ILOILO</strong></p>
                                            </vue-ellipse-progress>
                                        </center>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-4">
                            <div class="card card-custom gutter-b wave wave-animate-slow wave-danger">
                                <div class="card-body">
                                    <div class="text-enter">
                                        <center>
                                            <vue-ellipse-progress :progress="progressTotalInOffice"
                                                :legendValue="totalInOffice.length" fontSize="2.5rem" color="#E2231A">
                                                <span slot="legend-value"> </span>
                                                <p slot="legend-caption"
                                                    @click="viewSelectedEmployees(totalInOffice, 'Total In Office')"
                                                    style="cursor:pointer;"><strong>Total In Office</strong></p>
                                            </vue-ellipse-progress>
                                        </center>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-checkable" id="kt_datatable">
                                            ...
                                            <tbody>
                                                <tr v-for="(item, i) in filteredLastScannedEmployeeQueues" :key="i">
                                                    <td>
                                                        <strong
                                                            style="font-size:12px">{{ item.employee.last_name + ', ' + item.employee.first_name }}</strong><br>
                                                        <span style="font-size:11px"> {{ item.employee.position }} |
                                                            {{ item.employee.departments.length > 0 ? item.employee.departments[0].name : "" }}
                                                            |
                                                            {{ item.employee.locations.length > 0 ? item.employee.locations[0].name : "" }}</span>
                                                        <br>
                                                        <span style="font-size:11px">
                                                            {{ item.employee.door_id_number ? item.employee.door_id_number + ' |' : "" }}
                                                            {{ item.employee.rfid_64 }}</span>
                                                    </td>
                                                    <td style="vertical-align: middle;">
                                                        <strong style="font-size:12px;cursor:pointer;"
                                                            :class="locationColor(item)"
                                                            @click="showMap(item, item.employee)">{{ getCurrentLocation(item) }}</strong>
                                                        <br>
                                                        <strong
                                                            style="font-size:11px">{{ changeDateFormat(item.local_time) }}</strong>
                                                    </td>
                                                    <td align="center" style="vertical-align: middle;">
                                                        <a :href="'/view-history-logs?id=' + item.employee.id + '&v=' + Math.random()"
                                    ...
                                    <div class="row" v-if="filteredLastScannedEmployeeQueues.length">
                                        <div class="col-md-12">
                                            <span class="float-right">
                                                <button :disabled="!showPreviousLinkLastScannedEmployee()"
                                                    class="btn btn-default btn-sm btn-fill"
                                                    v-on:click="setPageLastScannedEmployee(currentPageLastScannedEmployee - 1)">
                                                    Previous </button>
                                                <span class="text-dark">Page {{ currentPageLastScannedEmployee + 1 }} of
                                                    {{ totalPagesLastScannedEmployee }}</span>
                                                <button :disabled="!showNextLinkLastScannedEmployee()"
                                                    class="btn btn-default btn-sm btn-fill"
                                                    v-on:click="setPageLastScannedEmployee(currentPageLastScannedEmployee + 1)">
                                                    Next </button>
                                            </span>
        ...
        <!-- Show Employees -->
        <div class="modal fade" id="view-data-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true" data-backdrop="static">
            <div class="modal-dialog modal-dialog-centered modal-lg modal-fixed" style="width:100%!important;"
                role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                        ...
                                        <tr v-for="(employee, i) in filteredEmployeeQueues" :key="i">
                                            <td width="20px" align="center" style="vertical-align: middle;">
                                                <div v-if="employee.user_favorite.length > 0">
                                                    <i v-if="employee.user_favorite[0].status == '1'"
                                                        class="fas fa-star text-warning" style="cursor:pointer;"
                                                        @click="saveFavorite(employee)"></i>
                                                    <i v-else class="far fa-star" style="cursor:pointer;"
                                                        @click="saveFavorite(employee)"></i>
                                                </div>
                                                <div v-else>
                                                    <i class="far fa-star" style="cursor:pointer;"
                                                        @click="saveFavorite(employee)"></i>
                                                </div>
                                            </td>
                                            <td width="20px" align="center" style="vertical-align: middle;">
                                            ...
                                            <td style="vertical-align: middle;">
                                                <strong
                                                    style="font-size:12px">{{ employee.last_name + ', ' + employee.first_name }}</strong><br>
                                                <span style="font-size:11px"> {{ employee.position }} |
                                                    {{ employee.departments.length > 0 ? employee.departments[0].name : "" }}
                                                    |
                                                    {{ employee.locations.length > 0 ? employee.locations[0].name : "" }}</span>
                                                <br>
                                                <span style="font-size:11px">
                                                    {{ employee.door_id_number ? employee.door_id_number + ' |' : "" }}
                                                    {{ employee.rfid_64 }}</span>
                                            </td>
                                            <td style="vertical-align: middle;">
                                                <div v-if="employee.employee_current_location_latest">
                                                    <strong style="font-size:12px;cursor:pointer;"
                                                        :class="locationColor(employee.employee_current_location_latest)"
                                                        @click="showMap(employee.employee_current_location_latest, employee)">{{ getCurrentLocation(employee.employee_current_location_latest) }}</strong>
                                                    <br>
                                                    <strong
                                                        style="font-size:11px">{{ changeDateFormat(employee.employee_current_location_latest.local_time) }}</strong>
                                                </div>
                                                <div v-else>
                                                    <span
                                            ...
                                            <td align="center" style="vertical-align: middle;">
                                                <a :href="'/view-history-logs?id=' + employee.id + '&v=' + Math.random()"
                                                    target="_blank"><i class="fas fa-street-view text-warning"
                                                        style="cursor:pointer;" title="View Logs"></i></a>
                                            </td>
                                        </tr>
                        ...
                        <div class="row" v-if="filteredEmployeeQueues.length">
                            <div class="col-md-12">
                                <span class="float-right">
                                    <button :disabled="!showPreviousLinkEmployee()" class="btn btn-default btn-sm btn-fill"
...
export default {
    ...
    methods: {
        ...
        getEmployees() {
            ...
            v.actualInIloilo = [];
            v.totalInIloilo = [];
            axios.get('/get-employees-data?limit=All')
                .then(response => {
...
<style lang="scss" scoped>.modal-fixed {
